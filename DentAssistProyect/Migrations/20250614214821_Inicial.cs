    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PasosPlan", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PasosPlan_PlanesTratamiento_PlanTratamientoId",
                        column: x => x.PlanTratamientoId,
                        principalTable: "PlanesTratamiento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PasosPlan_Tratamientos_TratamientoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasosPlan_PlanTratamientoId",
                table: "PasosPlan",
                column: "PlanTratamientoId");

            migrationBuilder.CreateIndex(
                name: "IX_PasosPlan_TratamientoId",
                table: "PasosPlan",
